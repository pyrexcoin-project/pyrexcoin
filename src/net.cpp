...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Pyrexcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pyrexcointools.com", "95.59.219.173"},
    
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"pyrexcointools.com", "testnet-seed.pyrexcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Pyrexcoin is probably already running."), addrBind.ToString().c_str());
        else
